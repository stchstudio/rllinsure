        ...
        <div class='grid-container'>
            <div class='grid-x grid-padding-x'>
                <div class='small-12 large-8 cell'>
                    <div class="front-hero__headline reveal-up load-hidden">
                        <?php echo get_field('headline'); ?>
                    </div>    
                </div>
            </div>
        </div>
        <?php if ( get_field('city_animation') ) : ?>
            <div id="lottieCityAnimation" class="front-hero__city-animation" data-animation="<?php echo get_field('city_animation'); ?>"></div>
        <?php endif; ?>
    </section>
<?php endif; ?>
...
<header class="front-greeter">
    <div class='grid-container'>
        <div class='grid-x grid-padding-x'>
            <div class='small-12 large-5 small-order-2 medium-order-2 large-order-1 cell'>
            ...
            <div class='small-12 medium-10 medium-offset-1 large-offset-0 large-6 small-order-1 medium-order-1 large-order-2 cell'>
                <?php if ( have_rows('carousel') ) : ?>
                    <div class="front-greeter__slick-wrapper">
                        <div class="front-greeter__slick">
                            <?php while( have_rows('carousel') ) : the_row(); ?>
                                <div class="front-greeter__slick__block">
        ...
        <div class='grid-container'>
            <div class='grid-x'>
                ...
                <div class='small-12 large-4 small-order-1 large-order-2 cell'>
                    <?php if ( get_field('waiver_animation') ) : ?>
                        <div class="waiver-animation">
                            <div class="waiver-animation__inner" id="lottieWaiver" data-animation="<?php echo get_field('waiver_animation'); ?>">
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
